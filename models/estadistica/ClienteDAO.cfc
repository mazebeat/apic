...
<cfcomponent output="false" accessors="true" extends="models.BaseModel">
	...
	<cffunction name="generarAcredPorDiasYPart" access="public" returntype="struct" output="false">	
        ...
        SELECT 
		    ...
		    DATE_FORMAT(CONVERT_TZ(fecha, 'Europe/Madrid', ZONAHORARIAEVENTO(#variables.instancia.id_evento#)), '%d/%m/%Y') AS fecha,
